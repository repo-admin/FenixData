...
BEGIN
	...
	DECLARE @resultId INT = (SELECT Id FROM dbo.CrmContractInetTypes WHERE f_inet_core_number = @inetCode);
	...
	ELSE
		BEGIN
			INSERT INTO dbo.CrmContractInetTypes(f_inet_core_number, f_inet_core_product) VALUES (@inetCode, @inetProduct);
			RETURN 1;
		END
