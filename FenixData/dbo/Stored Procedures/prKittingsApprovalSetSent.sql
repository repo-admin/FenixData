CREATE PROCEDURE [dbo].[prKittingsApprovalSetSent]
(
...
-- Description  : Kittings(Approval/potvrzeni) -> nastaveni datumu odeslani a statusu zpravy
...
--
BEGIN TRY
	UPDATE [dbo].[CommunicationMessagesKittingsApprovalSent]
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[prKittingsApprovalSetSent] TO [FenixW]
    AS [dbo];
