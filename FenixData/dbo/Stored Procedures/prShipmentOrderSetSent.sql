CREATE PROCEDURE [dbo].[prShipmentOrderSetSent]
(
...
-- Description  : Shipment Order (objednavka zavozu) -> nastaveni datumu odeslani a statusu zpravy
...
--
BEGIN TRY
	UPDATE [dbo].[CommunicationMessagesShipmentOrdersSent]
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[prShipmentOrderSetSent] TO [FenixW]
    AS [dbo];
