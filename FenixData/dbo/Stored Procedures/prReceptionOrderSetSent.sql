CREATE PROCEDURE [dbo].[prReceptionOrderSetSent]
(
...
-- Description  : Reception(Order) -> nastaveni datumu odeslani a statusu zpravy
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[prReceptionOrderSetSent] TO [FenixW]
    AS [dbo];
