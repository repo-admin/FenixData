CREATE TABLE [dbo].[CommunicationMessagesCrmOrderReturnedEquipmentParcelItems] (
    [ID]                                INT             IDENTITY (1, 1) NOT NULL,
    [CrmOrderReturnedEquipmentParcelID] INT             NOT NULL,
    ...
    [KitSNs]                            NVARCHAR (MAX)  NULL,
    [IsActive]                          BIT             DEFAULT ((1)) NOT NULL,
    [ModifyDate]                        DATETIME        NOT NULL,
    [ModifyUserID]                      INT             DEFAULT ((0)) NOT NULL,
    PRIMARY KEY CLUSTERED ([ID] ASC) WITH (FILLFACTOR = 85),
    FOREIGN KEY ([CrmOrderReturnedEquipmentParcelID]) REFERENCES [dbo].[CommunicationMessagesCrmOrderReturnedEquipmentParcel] ([ID])
);
