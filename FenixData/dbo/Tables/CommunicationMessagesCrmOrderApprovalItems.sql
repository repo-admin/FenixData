CREATE TABLE [dbo].[CommunicationMessagesCrmOrderApprovalItems] (
    [ID]                        INT             IDENTITY (1, 1) NOT NULL,
    [CrmOrderApprovalID]        INT             NOT NULL,
    ...
    FOREIGN KEY ([CrmOrderApprovalID]) REFERENCES [dbo].[CommunicationMessagesCrmOrderApproval] ([ID])
);
