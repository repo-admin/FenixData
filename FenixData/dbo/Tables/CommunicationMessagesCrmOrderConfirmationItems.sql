CREATE TABLE [dbo].[CommunicationMessagesCrmOrderConfirmationItems] (
    [ID]                        INT             IDENTITY (1, 1) NOT NULL,
    [CrmOrderConfirmationID]    INT             NOT NULL,
    ...
    FOREIGN KEY ([CrmOrderConfirmationID]) REFERENCES [dbo].[CommunicationMessagesCrmOrderConfirmation] ([ID])
);
